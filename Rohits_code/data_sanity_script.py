...
# formatted_queries = {
#     'logistics_NO_query': QUERIES.get('logistics_NO_query', None),
#     'B2C_NO_query': QUERIES.get('B2C_NO_query', None),
#     'B2B_NO_query': QUERIES.get('B2B_NO_query', None),
#     'GV_NO_query': QUERIES.get('GV_NO_query', None),
#     'logistics_OD_query': QUERIES.get('logistics_OD_query', None),
#     'B2C_OD_query': QUERIES.get('B2C_OD_query', None),
#     'B2B_OD_query': QUERIES.get('B2B_OD_query', None),
#     'GV_OD_query': QUERIES.get('GV_OD_query', None),
#     'OD_NO_validation_query': QUERIES.get('OD_NO_validation_query', None),
#     'B2C_L1_query': QUERIES.get('B2C_L1_query', None),
#     'B2B_L1_query': QUERIES.get('B2B_L1_query', None),
#     'GV_L1_query': QUERIES.get('GV_L1_query', None),
#     'logistics_L1_query': QUERIES.get('logistics_L1_query', None),
#     'B2C_L2_query': QUERIES.get('B2C_L2_query', None),
#     'B2B_L2_query': QUERIES.get('B2B_L2_query', None),
#     'GV_L2_query': QUERIES.get('GV_L2_query', None),
#     'logistics_L2_query': QUERIES.get('logistics_L2_query', None),
#     'L3_query_Retail': QUERIES.get('L3_query_Retail', None),
#     'L3_query_Logistics': QUERIES.get('L3_query_Logistics', None),
#     'logistics_NO_query_LRD': QUERIES.get('logistics_NO_query_LRD', None),
#     'B2C_NO_query_LRD': QUERIES.get('B2C_NO_query_LRD', None),
#     'B2B_NO_query_LRD': QUERIES.get('B2B_NO_query_LRD', None),
#     'GV_NO_query_LRD': QUERIES.get('GV_NO_query_LRD', None),
#     'logistics_OD_query_LRD': QUERIES.get('logistics_OD_query_LRD', None),
#     'B2C_OD_query_LRD': QUERIES.get('B2C_OD_query_LRD', None),
#     'B2B_OD_query_LRD': QUERIES.get('B2B_OD_query_LRD', None),
#     'GV_OD_query_LRD': QUERIES.get('GV_OD_query_LRD', None),
#     'OD_NO_validation_query_LRD': QUERIES.get('OD_NO_validation_query_LRD', None),
#     'B2C_L1_query_LRD': QUERIES.get('B2C_L1_query_LRD', None),
#     'B2B_L1_query_LRD': QUERIES.get('B2B_L1_query_LRD', None),
#     'GV_L1_query_LRD': QUERIES.get('GV_L1_query_LRD', None),
#     'logistics_L1_query_LRD': QUERIES.get('logistics_L1_query_LRD', None),
#     'B2C_L2_query_LRD': QUERIES.get('B2C_L2_query_LRD', None),
#     'B2B_L2_query_LRD': QUERIES.get('B2B_L2_query_LRD', None),
#     'GV_L2_query_LRD': QUERIES.get('GV_L2_query_LRD', None),
#     'logistics_L2_query_LRD': QUERIES.get('logistics_L2_query_LRD', None)
# }
...
# #     futures = {
# #         executor.submit(
# #             read_sql_query_and_format_time, query, athena_conn if 'NO' in key else engine
# #         ): key for key, query in formatted_queries.items()
# #     }
...
# for key, query in formatted_queries.items():
#     if query:
#         print(f"Running query for {key}")
#         try:
#             df = pd.read_sql_query(query, athena_conn if 'athena' in key else engine)
#             print(df.head())
#         except Exception as exc:
#             print(f"{key} generated an exception: {exc}")

# df_combined_athena = pd.concat(results.values(), ignore_index=True)
