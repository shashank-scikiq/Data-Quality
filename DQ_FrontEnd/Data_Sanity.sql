...
select
    ...
    'Voucher' as sub_domain_name, 
    'Retail' as domain_name, 
    'OD_with_base_query' as dashboard, 
    'shared_open_data_gift_voucher_order' as view_name,
...
select 
    date_format(date_parse(cast("order_date" as varchar) , '%Y-%m-%d'), '%Y-%m') as month, 
    'B2B' as sub_domain_name, 'Retail' as domain_name, 
    'OD_with_base_query' as dashboard, 
    'shared_open_data_b2b_order' as view_name,
    count(1) as row_count,
    count(distinct "network_order_id") as distinct_order_count 
from(
    SELECT 
...
select 
date_format(date_parse(cast("order_date" as varchar) , '%Y-%m-%d'), '%Y-%m') as month, 
'B2C' as sub_domain_name, 
'Retail' as domain_name, 
'OD_with_base_query' as dashboard, 
'nhm_order_fulfillment_subset_v1' as view_name,
count(1) as row_count,
...
select 
    date_format(date_parse(cast("order_date" as varchar) , '%Y-%m-%d'), '%Y-%m') as month, 
    'Logistics' as sub_domain_name, 
    'Logistics' as domain_name, 
    'OD_with_base_query' as dashboard, 
    'shared_open_data_logistics_order' as view_name,
    count(1) as row_count,
...
select date_format(date_parse(cast("Date" as varchar) , '%Y-%m-%d'), '%Y-%m') as month, 
...
select concat(order_year ,'-',order_month,'-','01') as month, 
