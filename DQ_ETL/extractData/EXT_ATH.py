import sys
import pathlib
print("Inside EXT_ATH file.")

current_path = pathlib.Path(__file__)
project_root = current_path.parent.parent
sys.path.append(str(project_root))

# print(f"Parent folder is {project_root}")

import aioboto3
import asyncio
from botocore.exceptions import ClientError

from Toolkit.utils import aws_region,aws_secret_access_key,aws_access_key_id
from Toolkit.utils import ATH_DB, S3_LOCATION
